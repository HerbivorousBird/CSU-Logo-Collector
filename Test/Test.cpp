...
unsigned int loadCubeMapFromFile(const char *filepath);
...
int main()
{
	...
	ResourceManager::LoadShader("cube_shader.vs", "cube_shader.fs", nullptr, "shader");
	...
	unsigned int skybox = ResourceManager::loadCubeMapFromFile("resources/textures/skybox/");
	...
	unsigned int cubemapTexture = loadCubeMapFromFile("resources/textures/skybox/");
